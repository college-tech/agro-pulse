        ...
        <div className="flex flex-col lg:flex-row items-end gap-12 mb-12">
          <div className="lg:w-1/2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-forest-accent font-bold uppercase tracking-widest text-sm">Live Global Tracking</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4 leading-tight">
              Interactive <span className="text-forest-accent">Forest Map</span>
            </h2>
                  ...
                  <div className="min-w-[220px] bg-forest-surface p-1 rounded-lg text-forest-text">
                    ...
                    <div className="space-y-2.5 text-sm">
                      ...
                      <div className="text-xs text-center pt-2 text-forest-muted">
                        Guardian: <span className="text-forest-accent">{tree.planter}</span>
                      </div>
                    </div>
                  </div>
                </Popup>
